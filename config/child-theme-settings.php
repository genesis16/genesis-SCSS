<?php
/**
 * Genesis SCSS starter theme theme settings.
 *
...
return [
	GENESIS_SETTINGS_FIELD => [
		...
		'entry_meta_before_content' => '[post_date] ' . __( 'by', 'genesis-scss-starter-theme' ) . ' [post_author_posts_link] [post_comments] [post_edit]',
