...
$genesis_scss_starter_theme_shared_content = genesis_get_config( 'onboarding-shared' );

return [
	'starter_packs' => [
		'black-white' => [
			'title'       => __( 'Black & White', 'genesis-scss-starter-theme' ),
			'description' => __( 'A pack with a homepage designed with black and white images.', 'genesis-scss-starter-theme' ),
			...
			'config'      => [
				'dependencies'     => [
					'plugins' => $genesis_scss_starter_theme_shared_content['plugins'],
				],
				'content'          => array_merge(
					[
						'homepage' => [
					...
					$genesis_scss_starter_theme_shared_content['content']
				),
				'navigation_menus' => $genesis_scss_starter_theme_shared_content['navigation_menus'],
				'widgets'          => $genesis_scss_starter_theme_shared_content['widgets'],
			],
		],
		'color'       => [
			'title'       => __( 'Color', 'genesis-scss-starter-theme' ),
			'description' => __( 'A pack with a homepage designed with color images.', 'genesis-scss-starter-theme' ),
