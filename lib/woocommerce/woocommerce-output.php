...
add_filter( 'woocommerce_enqueue_styles', 'genesis_scss_starter_theme_woocommerce_styles' );
/**
 ...
 */
function genesis_scss_starter_theme_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'genesis_scss_starter_theme_woocommerce_css' );
/**
 ...
 */
function genesis_scss_starter_theme_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'genesis_scss_starter_theme_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'genesis_scss_starter_theme_accent_color', $appearance['default-colors']['accent'] );
	...
	',
		$color_accent,
		genesis_scss_starter_theme_color_contrast( $color_accent )
	) : '';
