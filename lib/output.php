...
add_action( 'wp_enqueue_scripts', 'genesis_scss_starter_theme_css' );
/**
 ...
 * @since 2.2.3
 */
function genesis_scss_starter_theme_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'genesis_scss_starter_theme_logo_width', 350 );
